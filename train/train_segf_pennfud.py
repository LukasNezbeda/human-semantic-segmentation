"""
This file contains the training code for SegFormer on the Penn Fudan dataset.
"""
...
def main() -> None:
	...
	runs_root = os.path.join(project_root, "runs", "segf_pennfud")
	create_dir(runs_root)

	model_path = os.path.join(runs_root, "segformer_b0.h5")
