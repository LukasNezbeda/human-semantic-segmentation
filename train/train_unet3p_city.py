"""
This file contains the training code for unet 3 plus on the Cityscapes dataset.
"""
...
def main() -> None:
	"""Train Unet 3 Plus on Cityscapes."""
	""" Seeding """
	np.random.seed(42)
	...
	runs_root = os.path.join(project_root, "runs", "unet3p_city")
