"""
This file contains the training code for unet 3 plus on the Penn Fudan dataset.
"""
...
def main() -> None:
	"""Train Unet 3 Plus on Penn Fudan."""
	""" Seeding """
	np.random.seed(42)
	...
	runs_root = os.path.join(project_root, "runs", "unet3p_pennfud")
	create_dir(runs_root)

	model_path = os.path.join(runs_root, "unet3_plus.h5")
