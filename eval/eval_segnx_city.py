"""
This file contains the evaluation code for SegNext on the Cityscapes dataset.
"""
...
from train.train_segnx_city import load_data
...
# Pennfudan Testing
# model_path = os.path.join(project_root, "runs", "segnx_pennfud", "segnext.weights.h5")
# results_root = os.path.join(project_root, "results", "segnx_pennfud")
