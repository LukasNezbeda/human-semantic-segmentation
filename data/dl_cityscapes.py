"""
Script to download the Cityscapes dataset from Kaggle using curl.
This is a copy of dl_person_segmentation.py, but adapted for the Cityscapes dataset.

The dataset will be downloaded and extracted to: data/cityscapes/
...
def setup_dataset_directory() -> Path:
    ...
    Returns:
        Path: The path to the cityscapes directory.
    """
    dataset_dir = Path(__file__).parent / "cityscapes"
...
def main() -> None:
    """Main function to download the Cityscapes dataset."""
    print("=" * 60)
    print("Cityscapes Dataset Downloader")
    print("=" * 60)
